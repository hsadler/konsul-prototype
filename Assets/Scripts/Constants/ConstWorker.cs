...
public class ConstWorker
{
    ...
    public const int TASK_TYPE_REMOVE_CONSTITUENT_PART_AND_STORE = 4;
    ...
    public const int MODE_REMOVE_CONSTITUENT_PART = 7;
    public const int MODE_STORE_CONSTITUENT_PART = 8;
